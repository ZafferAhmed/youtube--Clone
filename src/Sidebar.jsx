const Sidebar = () => {
  return (
    <section className="flex flex-col items-center bg-gray-50 px-3 w-20 h-screen">
      <div className="flex items-center p-3 hover:bg-gray-200 hover:rounded-lg hover:cursor-pointer">
      ...
      <div className="flex items-center p-3 hover:bg-gray-200 hover:rounded-lg hover:cursor-pointer">
        <button type="button" className="flex flex-col items-center">
          ...
          <span className="text-[8px] font-mono">Shorts</span>
        </button>
      </div>

      <div className="flex items-center p-3 hover:bg-gray-200 hover:cursor-pointer hover:rounded-2xl">
        <button type="button" className="flex flex-col items-center gap-1">
          ...
          <span className="text-[8px] font-mono">Subscriptions</span>
        </button>
      </div>
